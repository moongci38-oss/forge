...
| # | 에셋명 | 도구 | 경로 | 비고 |
|:-:|--------|------|------|------|
| 1 | chest-opening-concept | Gemini 3 Pro | `_assets/_archive/p2-01-chest-opening-concept-gemini.png` | 스타일라이즈드 감성 강점 |
| 2 | card-grid | Gemini 3 Pro | `_assets/_archive/p2-02-card-grid-gemini.png` | 용 엠블럼 카드 뒷면 |
| 3 | pair-match | Gemini 3 Pro | `_assets/_archive/p2-03-pair-match-gemini.png` | 픽셀아트 아이템 + 번개 |
| 4 | result | Gemini 3 Pro | `_assets/_archive/p2-04-result-gemini.png` | "획득!" 텍스트 + 보라 검 |
| 5 | village-ui | Gemini 3 Pro | `_assets/_archive/p2-05-village-ui-gemini.png` | 캐릭터 + 7버튼 |

### P2 프로토타입 (대안본 — FLUX v2, _archive/)

| # | 에셋명 | 도구 | 시드 | 경로 | 비고 |
|:-:|--------|------|:----:|------|------|
| 2 | card-grid | FLUX 1.1 Pro | 14367 | `_assets/_archive/p2-02-card-grid-v2.png` | 퀄리티 저하 |
| 4 | result | FLUX 1.1 Pro | 36068 | `_assets/_archive/p2-04-result-v2.png` | 퀄리티 저하 |
| 5 | village-ui | FLUX 1.1 Pro | 35966 | `_assets/_archive/p2-05-village-ui-v2.png` | 퀄리티 저하 |

### 기존 에셋 (Diamond 이전 → archive/)

| # | 에셋명 | 유형 | 도구 | 경로 | 상태 |
|:-:|--------|------|------|------|:----:|
| 6 | bg-title | bg | NanoBanana | `_assets/archive/bg-title.png` | ✅ |
| 7 | bg-section | bg | NanoBanana | `_assets/archive/bg-section.png` | ✅ |
| 8 | illust-gacha | illust | NanoBanana | `_assets/archive/illust-gacha.png` | ✅ |
| 9 | gacha-cards-facedown | ui | Stitch | `_assets/archive/gacha-ui-mockups/gacha-cards-facedown-10slot.png` | ✅ |
| 10 | gacha-miss | ui | Stitch | `_assets/archive/gacha-ui-mockups/gacha-miss-next-time-smoke.png` | ✅ |
| 11 | gacha-pair-match | ui | Stitch | `_assets/archive/gacha-ui-mockups/gacha-pair-match-lightning-glow.png` | ✅ |
| 12 | gacha-win | ui | Stitch | `_assets/archive/gacha-ui-mockups/gacha-win-acquired-golden-burst.png` | ✅ |
...
| v1.1 | 2026-03-17 | P3 대량 생산 7장 (등급 이펙트 4종 + 스페셜 상자 + Row 리셋 + 버튼 상태) |
| v1.2 | 2026-03-17 | P4 일관성 검증 완료, archive 경로 정비, generated_imgs/ 정리 |
