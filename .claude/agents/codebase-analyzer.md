...
- **기본 경로**: `{PROJECT_ROOT}/.claude/reference/codebase-analysis.md` (L4 컨텍스트 레이어 — SDD/PGE 자동 참조)
- **REPORT_PATH 명시 시**: 지정 경로 사용 (예: `docs/reviews/YYYY-MM-DD-codebase-analysis-{session}.md`)
