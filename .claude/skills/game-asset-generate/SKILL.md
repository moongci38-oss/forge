...
description: 게임 에셋(스프라이트, VFX, 배경, 3D, UI, 아이콘, 오디오)을 에셋 유형에 따라 적절한 MCP 도구로 라우팅하여 대량 생산하는 오케스트레이터 스킬. Library-First 탐색 + 12요소 Soul 프롬프트 조립 + 모델어댑터 분기. 리소스 파이프라인 P3 단계.
user-invocable: true
---
