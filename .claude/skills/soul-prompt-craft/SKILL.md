...
description: 12요소 Soul-Injected 프롬프트를 조립하는 전문 스킬. style-guide + art-direction-brief에서 자동 추출하여 모델별 최적 포맷으로 변환한다. 이미지 생성 프롬프트의 품질을 극대화.
user-invocable: true
---
...
[6. 색상(HEX)]       ← style-guide §1 팔레트 + 긴장 악센트
