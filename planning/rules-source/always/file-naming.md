...
section: core
audience: all
impactDescription: "비일관적 파일명으로 검색 효율 30-50% 저하. Forge 산출물 자동 관리 불가"
...
### 01-research/
- `projects/{project}/YYYY-MM-DD-s{N}-{topic}.md` (Forge 프로젝트별 리서치)
...
### 02-product/
- `projects/{project}/YYYY-MM-DD-s{N}-{topic}.md` (Forge 프로젝트별 컨셉/PRD/GDD)
...
### 04-content/
- `projects/{project}/YYYY-MM-DD-s{N}-{topic}.md` (Forge 프로젝트별 콘텐츠)
...
- `shared/` -- forge-dev-sync 자동 배포, 수동 편집 금지
- `forge-dev/` -- forge-dev-sync 자동 배포, 수동 편집 금지
