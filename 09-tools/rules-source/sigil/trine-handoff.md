...
- **시안 이미지 = Human 승인된 디자인 명세로 취급한다 — Trine Spec에서 각 FR의 시각적 기준으로 참조 필수**
...
- **HANDOFF-IRON-1**: Handoff 문서 미생성 상태로 Trine에 진입하지 않는다
- **HANDOFF-IRON-2**: gate-log.md에 S4 PASS 또는 AUTO 기록이 없으면 Trine 진입을 거부한다
