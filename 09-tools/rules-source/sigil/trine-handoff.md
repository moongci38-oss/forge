...
2. S4 필수 산출물 7종이 존재함
3. Tier 2 Todo Tracker가 존재함 (`02-product/projects/{project}/YYYY-MM-DD-todo.md`)
...
Handoff 문서 자동 생성 (10-operations/handoff-to-dev/{project}/)
    ↓
Todo Tracker symlink 생성 (개발 프로젝트 docs/planning/active/sigil/todo.md)
    ↓
...
- Handoff 문서에 Tier 2 Todo Tracker 경로를 포함한다
...
- Tier 2 Todo Tracker 미생성 상태로 Trine에 진입하지 않는다
